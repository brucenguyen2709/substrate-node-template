...
//Every FRAME pallet has: frame_support and frame_system
...
pub mod pallet {
	...
	impl<T: Config> Pallet<T> {
        ...
        // TODO Part IV: set_price. set the price for a kitty
        ...
        // TODO Part IV: buy_kitty ?? not_frontend
		...
		pub fn buy_kitty(
			...
			log::info!("A kitty [{:?}] was bought by : {:?}.", kitty_id, buyer);
